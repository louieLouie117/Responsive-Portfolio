        ...
        <div  className="basicAlgos-container">
            <ul>
                <li>
                    ...
                    <h3>{print}</h3>
                    <button 
                    style={{ background:  print? "gray" : "rgb(235, 201, 8)" }}
                    disabled={print}
                    onClick={printFunction}>Print 1-250</button>
                </li>
                ...
                <li>
                    ...
                    <h3>{odds}</h3>
                    <button 
                    style={{ background:  odds? "gray" : "rgb(235, 201, 8)" }}
                    disabled={odds}
                    onClick={printOdds}
                    >Print Odd #</button>
                </li>
                ...
                <li>
                    ...
                    <h3>{sumOdds}</h3>
                    <button 
                    style={{ background:  sumOdds? "gray" : "rgb(235, 201, 8)" }}
                    disabled={sumOdds}
                    onClick={sumAllOdds}
                    >Sum all odds </button>
                </li>
